...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Flutter Test Liveness", style: GoogleFonts.mukta())),
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              (dataGambarCard != null) ? Column(children: [Container(height: 300, width: 300, color: Colors.blue, child: Image.memory(base64Decode(dataGambarCard!))), const SizedBox(height: 10)]) : const SizedBox(),
              (dataGambar != null) ? Container(height: 100, width: 100, color: Colors.blue, child: Image.memory(base64Decode(dataGambar!))) : const SizedBox(),
              (dataOcr != null) ? Column(children: [Text("dataOcr\n\n $dataOcr"), const SizedBox(height: 10)]) : SizedBox(height: MediaQuery.of(context).size.height * .35),
              (dataOcr2 != null)
                  ? Text("dataOcr KTP Mapping\n\n $dataOcr2")
                  : const SizedBox(
                      // height: MediaQuery.of(context).size.height * .35,
                      ),
              Text("Flutter Test Liveness", style: GoogleFonts.mukta()),
              Wrap(
              ...
              ElevatedButton(
                ...
                child: Text("Test Liveness Autentika", style: GoogleFonts.mukta()),
              ),
            ],
          ),
        ),
